...
P(all(o["chosen"] == "Augustus 2024.xlsx" for o in overlaps),
...
P("chosen_overlap" in codes, "and another names the months it had to decide")
solo = analysis.run(window="files:dec", tenant=T, save=False)
P("chosen_overlap" not in [c["code"] for c in solo["headline"]["caveats"]],
